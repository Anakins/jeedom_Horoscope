                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">{{Signe du zodiaque}}
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 text-center">
                                    <img src="plugins/horoscope/core/img/default.png" data-original=".jpg" id="img_device" class="img-responsive" style="width:120px" onerror="this.src='plugins/horoscope/core/img/default.png'" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
